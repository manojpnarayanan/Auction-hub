...
import { ISubscriptionDocument, SubscriptionModel } from "../models/SubscriptionModel";
import { AuctionModel } from "../models/AuctionModel";
import { BaseRepository } from "./BaseRepository";
import { SubscriptionPersistanceMapper } from "../Mappers/SubscriptionPersistanceMapper";


@injectable()
export class MongoSubscriptionRepository extends BaseRepository<Subscription,ISubscriptionDocument> implements ISubscriptionRepository{

    constructor(){super(SubscriptionModel,SubscriptionPersistanceMapper.toEntity)}
