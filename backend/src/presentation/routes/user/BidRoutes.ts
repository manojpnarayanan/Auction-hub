...
router.post(ROUTES.BID.BID_PLACE,isUser,(req,res,next)=>bidController.placeBid(req,res,next));
router.get(ROUTES.BID.BID_GET_MINE,isUser,(req,res,next)=>bidController.getMyBids(req,res,next));
