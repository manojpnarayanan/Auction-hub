            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="space-y-2">
                  <input
                    ...
                    className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:ring-1 focus:ring-[#1da1f2] outline-none" required
                  />
                  ...
                  {[{ key: "password", val: form.password, show: showPassword, set: setShowPassword, ph: "Password" },
                    ...
                    <div key={field.key} className="relative">
                        <input
                           ...
                           className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:ring-1 focus:ring-[#1da1f2] outline-none pr-8" required
                        />
