          ...
          <div className="px-6 pb-6">
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="pt-1 space-y-2">
                ...
                <button type="button" onClick={() => signupWithGoogle()} className="w-full bg-white border border-gray-200 text-gray-600 py-2.5 rounded-lg font-semibold text-sm hover:bg-gray-50 flex items-center justify-center gap-2 transition-all">
